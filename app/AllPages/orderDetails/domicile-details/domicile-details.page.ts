...
@Component({
  selector: 'app-domicile-details',
  templateUrl: './domicile-details.page.html',
  styleUrls: ['./domicile-details.page.scss'],
})
export class DomicileDetailsPage implements OnInit {
  gotFormType: any;
  viewFormType: any;
  formDetails: any;
