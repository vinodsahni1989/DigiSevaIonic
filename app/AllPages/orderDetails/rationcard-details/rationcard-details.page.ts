...
@Component({
  selector: 'app-rationcard-details',
  templateUrl: './rationcard-details.page.html',
  styleUrls: ['./rationcard-details.page.scss'],
})
export class RationcardDetailsPage implements OnInit {
