...
@Component({
  selector: 'app-parivarik-details',
  templateUrl: './parivarik-details.page.html',
  styleUrls: ['./parivarik-details.page.scss'],
})
export class ParivarikDetailsPage implements OnInit {
