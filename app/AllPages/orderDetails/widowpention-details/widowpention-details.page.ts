...
@Component({
  selector: 'app-widowpention-details',
  templateUrl: './widowpention-details.page.html',
  styleUrls: ['./widowpention-details.page.scss'],
})
export class WidowpentionDetailsPage implements OnInit {
  gotFormType: any;
  viewFormType: any;
  formDetails: any;
