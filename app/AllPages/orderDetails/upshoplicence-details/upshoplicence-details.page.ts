...
@Component({
  selector: 'app-upshoplicence-details',
  templateUrl: './upshoplicence-details.page.html',
  styleUrls: ['./upshoplicence-details.page.scss'],
})
export class UpshoplicenceDetailsPage implements OnInit {
