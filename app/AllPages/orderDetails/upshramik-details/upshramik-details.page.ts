...
@Component({
  selector: 'app-upshramik-details',
  templateUrl: './upshramik-details.page.html',
  styleUrls: ['./upshramik-details.page.scss'],
})
export class UpshramikDetailsPage implements OnInit {
