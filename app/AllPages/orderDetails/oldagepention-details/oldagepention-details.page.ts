...
@Component({
  selector: 'app-oldagepention-details',
  templateUrl: './oldagepention-details.page.html',
  styleUrls: ['./oldagepention-details.page.scss'],
})
export class OldagepentionDetailsPage implements OnInit {
