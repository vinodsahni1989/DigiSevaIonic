...
@Component({
  selector: 'app-pvccard-details',
  templateUrl: './pvccard-details.page.html',
  styleUrls: ['./pvccard-details.page.scss'],
})
export class PvccardDetailsPage implements OnInit {
  ...
  submitStatus() {
    ...
    console.log("update param", JSON.stringify(updateStatuParam));
