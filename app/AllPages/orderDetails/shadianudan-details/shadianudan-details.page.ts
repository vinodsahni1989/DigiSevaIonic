...
@Component({
  selector: 'app-shadianudan-details',
  templateUrl: './shadianudan-details.page.html',
  styleUrls: ['./shadianudan-details.page.scss'],
})
export class ShadianudanDetailsPage implements OnInit {
