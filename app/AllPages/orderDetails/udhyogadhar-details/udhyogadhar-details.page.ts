...
@Component({
  selector: 'app-udhyogadhar-details',
  templateUrl: './udhyogadhar-details.page.html',
  styleUrls: ['./udhyogadhar-details.page.scss'],
})
export class UdhyogadharDetailsPage implements OnInit {
